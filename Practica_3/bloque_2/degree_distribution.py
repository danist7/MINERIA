...
#    dibujar_grafo(G,dir,"facebook_combined")
    ...
    network = transforma_csv(dir,"amigos_comunes.csv","amigos_comunes_transformado.csv",'\t')
    G,avg= estudiar_grafo(dir+"amigos_comunes_transformado.csv","amigos_comunes",dir)
    dibujar_grafo(G,dir,"amigos_comunes")
    paradoja_amistad(network,avg,"amigos_comunes")
